...
impl AppConfig {
    pub fn load() -> Self {
        ...
        Self {
            ...
            http_port: env::var("HTTP_PORT").or_else(|_| env::var("OBSERVER_SERVICE_HTTP_PORT")).unwrap_or("11070".to_string()).parse().unwrap_or(11070),
            grpc_port: env::var("GRPC_PORT").or_else(|_| env::var("OBSERVER_SERVICE_GRPC_PORT")).unwrap_or("11071".to_string()).parse().unwrap_or(11071),
            metric_port: env::var("METRIC_PORT").or_else(|_| env::var("OBSERVER_SERVICE_METRICS_PORT")).unwrap_or("11072".to_string()).parse().unwrap_or(11072),
